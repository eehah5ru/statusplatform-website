...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder "www/", "/srv/www", :type => "rsync", :rsync__args => ["--verbose", "--archive", "--delete", "-z", "--links", "--no-owner", "--no-group"] #, :owner => "www-data" # :mount_options => [ "dmode=775", "fmode=774" ]
